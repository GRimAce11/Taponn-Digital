...
const Contact = () => {
  return (
    <section id="contact" class="font-primary pt-20 lg:relative static w-full min-h-screen bg-black text-white">
    ...
    <div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
        ...
        <div class="bg-black border border-white w-full lg:w-1/2 h-full p-5 pt-8">
            <h3 class="text-2xl font-semibold mb-5">
            My Social Media
            </h3>
           {/*  list */}
            <div class="flex flex-col gap-3">
            <a href="#" class="flex items-center hover:text-black hover:bg-white  p-2">
        ...
        {/* <!-- Contact Me --> */}
        <form action="#" class="w-full md:w-1/2 border border-white p-6 bg-black">
        ...
        <div>
            ...
            <input 
                type="text" id="name" 
                class="px-3 py-2 bg-transparent border border-white focus:border-red-500 focus:outline-none focus:bg-white focus:text-black"
                autocomplete="off"/>
            </div>
            <div class="flex flex-col mb-3">
        ...
        <div class="w-full pt-3">
            <button type="submit" class="w-full bg-transparent border border-white px-4 py-2 transition duration-50 focus:outline-none font-semibold hover:bg-white hover:text-black text-xl cursor-pointer">
            Send
            </button>
        </div>
        </form>
